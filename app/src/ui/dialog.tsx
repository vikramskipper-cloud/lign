  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-[--radius-lg] border border-[--color-border] bg-[--color-surface] p-6 shadow-[--shadow-md]',
        className,
      )}
      {...props}
    >
      ...
      <DialogPrimitive.Close
        className="absolute right-4 top-4 rounded-[--radius-sm] p-1 text-[--color-text-muted] hover:bg-[--color-surface-2]"
      >
        <X className="h-4 w-4" />
